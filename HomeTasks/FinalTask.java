...
public class FinalTask {
    public static void main(String[] args) 
    {
        ...
        // System.out.printf("Введите номер строки, на которой будет располагаться точка старта(диапазон от 1 до rows): ");
        // int startingPointRow = isScanner.nextInt();
        // System.out.printf("Введите номер столбца, на котором будет располагаться точка старта(диапазон от 1 до columns): ");
        // int startingPointColumns = isScanner.nextInt();

         // System.out.printf("Введите номер строки, на которой будет располагаться точка финиша(диапазон от 1 до rows): ");
        // int startingPointRow = isScanner.nextInt();
        // System.out.printf("Введите номер столбца, на котором будет располагаться точка финиша(диапазон от 1 до columns): ");
        // int startingPointColumns = isScanner.nextInt();
